        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ModalidadesId = table.Column<int>(type: "int", nullable: false),
                    Modalidade = table.Column<int>(type: "int", nullable: true),
                    EquipasId = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.InsertData(
                table: "Equipas",
                columns: new[] { "Id", "Categoria", "CategoriaId", "Modalidade", "ModalidadesId", "Nome", "TreinadoresId" },
                values: new object[] { 1, 1, 0, 1, 0, "Flamengo", null });

            migrationBuilder.InsertData(
                table: "Equipas",
                columns: new[] { "Id", "Categoria", "CategoriaId", "Modalidade", "ModalidadesId", "Nome", "TreinadoresId" },
                values: new object[] { 2, 2, 0, 1, 0, "PSG", null });
